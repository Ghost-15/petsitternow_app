...
class AddPetViewModel @Inject constructor(
    ...
    fun addPhotoUris(uris: List<Uri>) {
        val currentUris = _state.value.photoUris.toMutableList()
        currentUris.addAll(uris)
        _state.value = _state.value.copy(photoUris = currentUris, error = null)
    }

    fun removePhotoUri(uri: Uri) {
        val currentUris = _state.value.photoUris.toMutableList()
        currentUris.remove(uri)
        _state.value = _state.value.copy(photoUris = currentUris)
    }
    ...
    fun submitPet() {
        ...
        viewModelScope.launch {
            try {
                ...
                s.photoUris.forEachIndexed { index, uri ->
